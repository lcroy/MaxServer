...
# temp = {'slot': [['small', 'B-DELIVERY_OBJECT_SIZE'], ['black', 'B-DELIVERY_OBJECT_COLOR'], ['', 'B-DELIVERY_OBJECT'],
#                  ['', 'B-DELIVERY_POSITION'], ['Kate', 'B-DELIVERY_PERSON']]}
# text = "can you delivery this small black box to warehouse and give it to Kate"
# print("The user utterance is =======================================================")
# print(text)
# print("===================== =======================================================")
# pred_intent_slot(text, temp, 'mir')
#
# cfg = Config()
# pred_main(cfg, "how are you today")
# pred_result, pred_service, language_service_result_flag, updated_client_slot_result, required_slot_list = pred_intent_slot('how are you today', 'none', 'main')
#
# print(pred_result, pred_service, language_service_result_flag, updated_client_slot_result, required_slot_list)

# pred_intent_slot('Can you bring this small box to warehouse', {'slot':'none'}, 'main')