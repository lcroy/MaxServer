...
#
# cfg = Config()
# # print(run_pred_mir(cfg, "Hey mir, I want to buy a book", 1, False))
#
# pred_result, confidence = run_pred_mir(cfg, "I need you to bring this big black box to office. Please give it to Tom.", 1)
#
# print(pred_result, confidence)
#
# import re
...
#                 print("The person who should receive this is " + re.sub(r, '', item[0]))
#         if item[1] == 'B-DELIVERY_OBJECT':
#             if (re.sub(r, '', item[0]) != 'it'):
#                 print("The object is " + re.sub(r, '', item[0]))
#         if item[1] == 'B-DELIVERY_POSITION':
#             print("The destination is " + re.sub(r, '', item[0]))
#         if item[1] == 'B-DELIVERY_OBJECT_COLOR':
#             print("The object color is " + re.sub(r, '', item[0]))
#         if item[1] == 'B-DELIVERY_OBJECT_SIZE':
#             print("The object size is " + re.sub(r, '', item[0]))
