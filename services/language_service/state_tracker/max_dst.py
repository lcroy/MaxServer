...
def max_dst(cfg, pred_result, client_slot_result, pred_service):
    ...
    # print(client_slot_result)
    # print("required slot:" + str(required_slot_list))
...
# cfg = Config()
# pred_result = {'intent': 'DELIVERY', 'slot': [['small', 'B-DELIVERY_OBJECT_SIZE'], ['box', 'B-DELIVERY_OBJECT'], ['warehouse', 'B-DELIVERY_POSITION']]}
# client_slot_result = {'slot':'none'}
# pred_service = 'mir'
#
# client_slot_result, required_slot_list = max_dst(cfg, pred_result, client_slot_result, pred_service)
#
# pred_result = {'intent': 'DELIVERY', 'slot': [['kate', 'B-DELIVERY_PERSON']]}
#
# client_slot_result, required_slot_list = max_dst(cfg, pred_result, client_slot_result, pred_service)