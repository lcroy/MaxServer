########################################################################################################################
# Response repository for Max
# Date: 29/9/2019 -
########################################################################################################################
# wrong requests
MISSUNDERSTANDING = ["Sorry, I think I did not hear that clearly. Can you repeat?",
                     "I might miss understanding something here. Would you mind to repeat?",
                     "Well, I am not sure if I understand. Can you say it again?"]
...
# Initial speaking
init_speak = ["hey, this is Jason, what can I do for you.",
              "Yes, I am ready.",
              "what's up.",
              "Jason is here. How can I help."]

init_speak_mia = ['Hello, this is Max. I am ready to work.']

mia_key_words = {'battery': 'battery', 'target': 'warehouse'}

mia_response = {
    "battery": ["my battery is ", "Here is my battery info "],
    "greeting":["All good. Thanks.", "Not bad. Thank you."],
    "mirfree":["Well, I am totally free now.", "em, nothing on my schedule."],
    "mirbusy":["Well, I need to go to ", "Yeah, I am on the way to "],
    ...
    "delivery_color_or_size":["Sorry, I did not hear clearly, Can you describe a bit of it? the color and size.", "Sorry, I did not catch it. Can you tell me what kind of color and size, please"],
    "delivery_des": ["Sorry, I did not hear clearly, Can you describe the destination"],
    ...
    "location": ["Ok, I am currently close to ", "Well, I think I am close to "],
    "wait": ["Sure, what is it ?", "Yes, I am listening. what do you want", "Ok, I will stop."],
